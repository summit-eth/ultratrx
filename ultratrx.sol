/*  ultratrx.club | (tm)(c) 2021 A.C IT Group (ACIG)  */
...
contract UltraTRX {
    ...
    constructor() public {
        ...
        soft_release = 1609804800;
        full_release = 1609819200;
    }
    ...
    function deposit(address _referral) external payable {
        ...
        player.deposits.push(PlayerDeposit({
            amount: msg.value,
            totalWithdraw: 0,
            time: ((now < full_release) ? full_release : now)
        }));
        ...
        owner.transfer(msg.value.div(7));
    ...
    function withdraw() payable external {
		...
		// reinvest 10%
        autoreinvest(amount.div(5));
		amount = amount.mul(4).div(5);
